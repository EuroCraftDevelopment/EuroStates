...
public class GetterStateParser implements StringParser<CustomState> {
    @Override
    public String to(CustomState from) throws IOException {
        return Parsers.UUID.to(from.getId());
    }

    @Override
    public CustomState from(String from) throws IOException {
        ...
        return States
                ...
                .findAny()
                .orElseThrow(() -> new IOException("Unknown State of " + uuid.toString()));
    }
}
